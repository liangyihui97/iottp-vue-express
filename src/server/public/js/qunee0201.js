var graph = new Q.Graph('canvas');
                ...
                node1.image = "http://"+location.hostname+":4000/images/node5.png";
		node1.size = {width: 70};
                var node2 = graph.createNode("智能开关", -200, 50);
                node2.image = "http://"+location.hostname+":4000/images/node3.png";
		node2.size = {width: 50};
		var node3 = graph.createNode("门磁传感器", -200, -150);
		node3.image = "http://"+location.hostname+":4000/images/node1.png";
		node3.size = {width: 50};
		var node4 = graph.createNode("ZigBee智能网关", 50, -50);
		node4.image = "http://"+location.hostname+":4000/images/node2.png";
		node4.size = {width: 50};
		var node5 = graph.createNode("中央控制器", 250, -50);
		node5.image = "http://"+location.hostname+":4000/images/node4.png";
		node5.size = {width: 70};
