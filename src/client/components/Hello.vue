     ...
     <div class="banner-content fl"> 
      <div class="fl"> 
       <ul> 
        <li>
         <div>
          <a>三部门发布加强绿色数据中心建设指导意见</a>
         </div></li> 
        <li>
         <div>
          <a>智慧医疗满意度先行 三级公立医院将全部纳入满意度调查平台</a>
         </div></li> 
        <li>
         <div>
          <a>智能家电、信息消费成主力 10部门联合印发《实施方案》推动消费增长</a>
         </div></li> 
        <li>
         <div>
          <a>工信部公示2018年工业互联网APP优秀解决方案 89家企业入选</a>
         </div></li> 
        <li>
         <div>
          <a>三部门发布加强绿色数据中心建设指导意见</a>
        ...
        <div id="container"> 
         <div class="inner"> 
          ...
          <article> 
           <div class="caption"> 
            <bar>
             智能家电、信息消费成主力 10部门联合印发《实施方案》推动消费增长
             <a href="#">详情</a>
            </bar> 
           </div> 
          ...
          <article> 
           <div class="caption"> 
            <bar>
             工信部公示2018年工业互联网APP优秀解决方案 89家企业入选
             <a href="#">详情</a>
            </bar> 
           </div> 
         ...
         <div> 
          <div class="video-content u-clist"> 
           <div class="video-img fl">
            <img src="../static/images/video01.png" />
           </div> 
           <div class="content"> 
          ...
          <div class="video-content u-clist"> 
           <div class="video-img fl">
            <img src="../static/images/video02.png" />
           </div> 
           <div class="content"> 
            <div class="content-title "> 
             <a>物联网工程导论</a> 
          ...
          <div class="video-content u-clist"> 
           <div class="video-img fl">
            <img src="../static/images/video03.jpg" />
           </div> 
           <div class="content"> 
            <div class="content-title "> 
             <a>物联网概论</a> 
          ...
          <div class="video-content u-clist"> 
           <div> 
            <div class="video-img fl">
             <img src="../static/images/video04.jpg" />
            </div> 
            <div class="content"> 
             <div class="content-title "> 
              <a>物联网工程导论</a> 
          ...
          <div class="video-content u-clist"> 
           <div class="video-img fl">
            <img src="../static/images/video05.jpg" />
           </div> 
           <div class="content"> 
            <div class="content-title "> 
             <a>带你揭开神秘的物联网</a> 
     ...
     <div class="banner-title other fr"> 
      ...
      <div class="data-all"> 
       <template v-for="txt in txts"> 
        <div class="data fl"> 
         <a> <img :src="txt.src" width="20" height="20" class="fl" /> 
          <div class="fl">
            {{txt.content}} 
          </div> </a> 
        </div> 
...
<script>
import pane from './pane'import tabs from './tabs'
export default {
        components:
        {
            pane,
